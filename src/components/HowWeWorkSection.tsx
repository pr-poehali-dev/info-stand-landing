...
const HowWeWorkSection = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'Дизайн-концепция, типографика, 3D-визуализация, спецификация материалов.'
    },
    {
      id: 3,
      icon: 'FileCheck',
    ...
    },
    {
      ...
      icon: 'FileText',
      title: 'Документы',
      description: 'Смета, договор, счета, закрывающие документы; паспорта изделий и инструкции по уходу.'
    },
    {
      id: 7,
      icon: 'Shield',
      title: 'Сервис',
      description: 'Гарантия, постгарантийная поддержка, оперативная замена графики.'
    }
  ];
